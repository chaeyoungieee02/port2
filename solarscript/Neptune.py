...
# Create a UV sphere for Neptune
bpy.ops.mesh.primitive_uv_sphere_add(radius=1, segments=64, ring_count=32)
neptune = bpy.context.active_object
neptune.name = "Neptune"

# Add subdivision surface modifier
neptune.modifiers.new(name="Subdivision", type='SUBSURF')
neptune.modifiers["Subdivision"].levels = 2
neptune.modifiers["Subdivision"].render_levels = 3

# Create material and assign texture
texture_path = r"C:\Users\yuend\Downloads\Universe Factory\2ND YEAR - 3RD SEM\M&A\solarsystem_textures\2k_neptune.jpg"
...
# Add Neptune-specific material properties (ice giant appearance)
...
# Neptune rotates faster than Uranus (about 16.1 hours per day)
# About 1.86 full rotations during the 5-second animation
neptune.rotation_euler = (0, 0, 0)
neptune.keyframe_insert(data_path="rotation_euler", frame=0)
neptune.rotation_euler = (0, 0, math.pi * 3.72)  # 1.86 full rotations (3.72π radians)
neptune.keyframe_insert(data_path="rotation_euler", frame=120)

# Linear interpolation
if neptune.animation_data and neptune.animation_data.action:
    action = neptune.animation_data.action
    try:
...
print("Neptune planet animation setup complete!")